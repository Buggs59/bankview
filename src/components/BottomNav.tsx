...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 w-full flex justify-center pb-8 pt-4 px-4 bg-gradient-to-t from-black to-transparent pointer-events-none z-50">
